    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<MainLayout />}>
          ...
          <Route path="student" element={<Navigate to="/student/all" replace />} />
          <Route path="teacher/all" element={<Teacher />} />
          <Route path="teacher/:id" element={<TeacherDetails />} />
          <Route path="teacher" element={<Navigate to="/teacher/all" replace />} />
          ...
          <Route path="academic" element={<Navigate to="/academic/structure" replace />} />
